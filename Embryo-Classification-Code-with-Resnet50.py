...
"""
Created on Tue Oct 24 01:13:38 2023
@author: btouati
"""
                ...
                if os.path.isdir(sub_folder_path):
                    ...
                    for image_name in os.listdir(sub_folder_path):
                        ...
                        if image is not None:
                            # Redimensionnez l'image pour correspondre aux dimensions d'entrée de ResNet-50
...
x = Dropout(0.3)(x) #regularisation
...
checkpoint_callback = ModelCheckpoint('Embryo_classification_model_Resnet50.h5', save_best_only=True)
...
history_df.to_excel("Embryo_training_results.xlsx", index=False)
